...
interface DocumentEngineTemplatesPageProps {
	designerRoute:
		| "/admin/document-engine/designer/$templateId"
		| "/demo/document-engine/designer/$templateId";
}

export function DocumentEngineTemplatesPage({
	designerRoute,
}: DocumentEngineTemplatesPageProps) {
	...
	const handleCreate = useCallback(async () => {
		...
		try {
			...
			setError(
				createError instanceof Error ? createError.message : "Failed to create"
			);
		}
	}, [basePdfId, createTemplate, description, name]);
