...
const standardLawyers: ListingLawyerOption[] = [
	...
	},
	{
		...
		email: "closing@jones.example",
		firm: "Jones Law Professional Corp.",
		type: "platform_lawyer",
	},
];
...
function buildListing(
	...
	return {
		...
		atAGlance: overrides.atAGlance ?? [
			...
			{ label: "Per Fraction", value: "$45,000" },
		...
		investment: overrides.investment ?? {
			availabilityLabel: "6.2 of 10 available",
...
export const listingDetailMocks: Partial<Record<string, ListingDetailMock>> = {
	...
	"first-mortgage-condo-scarborough": buildListing({
		...
		atAGlance: [
			...
			{ label: "Per Fraction", value: "$32,000" },
		...
		investment: {
			availabilityLabel: "6 of 10 available",
	...
	"second-mortgage-vaughan": buildListing({
		...
		atAGlance: [
			...
			{ label: "Per Fraction", value: "$18,800" },
		...
		investment: {
			availabilityLabel: "5.2 of 10 available",
	...
	"first-mortgage-semi-etobicoke": buildListing({
		...
		atAGlance: [
			...
			{ label: "Term", value: "24 months" },
			{ label: "Per Fraction", value: "$38,000" },
