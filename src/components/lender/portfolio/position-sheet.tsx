					...
					>
						<div className="space-y-4">
							...
							<PortfolioKeyValueGrid className="lg:grid-cols-4">
								<PortfolioKeyValueRow
									label="Held"
									value={formatPortfolioFractions(data.position.fractionCount)}
								/>
								<PortfolioKeyValueRow
									label="Position"
									value={formatPortfolioPercent(data.position.positionPercent)}
								/>
								<PortfolioKeyValueRow
									label="Est. value"
						...
						<TabsContent className="mt-0" value="terms">
							...
							>
								<PortfolioKeyValueGrid>
									...
									<PortfolioKeyValueRow
										label="First payment"
										value={formatPortfolioDate(data.mortgage.firstPaymentDate)}
									/>
									<PortfolioKeyValueRow
										label="Maturity"
