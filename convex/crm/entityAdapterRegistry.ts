...
const DEDICATED_ENTITY_VIEW_ADAPTERS = [
	...
	},
	{
		...
		computedFields: [
			{
				description:
					"Hydrated mortgage summary for the mortgage linked to the deal.",
				expressionKey: "dealMortgageSummary",
				fieldName: "mortgageSummary",
				fieldType: "text",
				isVisibleByDefault: true,
				label: "Mortgage",
			...
			{
				description: "Principal amount from the mortgage linked to the deal.",
				expressionKey: "dealLoanAmount",
			...
			{
				description:
					"Dollar amount represented by the deal's fractional share.",
				expressionKey: "dealFractionAmount",
				...
				materializationMode: "hydrated",
				rendererHint: "computed",
				sourceFieldNames: ["mortgageId", "fractionalShare"],
			},
			{
				description: "Hydrated lender identity for the deal.",
				expressionKey: "dealLenderSummary",
				...
				materializationMode: "hydrated",
				rendererHint: "computed",
				sourceFieldNames: ["lenderId"],
			},
			{
				description:
					"Hydrated principal broker from the linked mortgage's broker of record.",
				expressionKey: "dealPrincipalBrokerSummary",
			...
			{
				description:
					"Hydrated borrower rollup from the mortgage linked to the deal.",
				expressionKey: "dealBorrowerSummary",
				fieldName: "borrowerSummary",
				fieldType: "text",
				isVisibleByDefault: true,
				label: "Borrower",
		...
		layoutDefaults: {
			calendarDateFieldName: "lockingDate",
			kanbanFieldName: "status",
			preferredVisibleFieldNames: [
				"lockingDate",
				"mortgageSummary",
