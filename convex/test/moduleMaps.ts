...
export const convexModules: ModuleMap = withModuleAliases({
	...
	"/convex/admin/portfolio/mutations.ts": async () =>
		await import("./../admin/portfolio/mutations.ts"),
	"/convex/admin/portfolio/context.ts": async () =>
		await import("./../admin/portfolio/context.ts"),
	...
	"/convex/admin/settings/mockMortgages.ts": async () =>
		await import("./../admin/settings/mockMortgages.ts"),
	...
	"/convex/deals/closeEvidence.ts": async () =>
		await import("./../deals/closeEvidence.ts"),
	"/convex/deals/envelopeWebhooks.ts": async () =>
		await import("./../deals/envelopeWebhooks.ts"),
	"/convex/deals/envelopes.ts": async () =>
		await import("./../deals/envelopes.ts"),
	"/convex/deals/lawyerQueries.ts": async () =>
		await import("./../deals/lawyerQueries.ts"),
	"/convex/deals/lawyerMutations.ts": async () =>
		await import("./../deals/lawyerMutations.ts"),
	...
	"/convex/velocity/exceptions.ts": async () =>
		await import("./../velocity/exceptions.ts"),
	"/convex/velocity/review.ts": async () =>
		await import("./../velocity/review.ts"),
	"/convex/velocity/mock.ts": async () => await import("./../velocity/mock.ts"),
	...
	"/convex/velocity/workspaces.ts": async () =>
		await import("./../velocity/workspaces.ts"),
	...
	"/convex/legalRepresentation/invitations.ts": async () =>
		await import("./../legalRepresentation/invitations.ts"),
	"/convex/legalRepresentation/management.ts": async () =>
	...
	"/convex/legalRepresentation/status.ts": async () =>
		await import("./../legalRepresentation/status.ts"),
	"/convex/legalRepresentation/tokenUtils.ts": async () =>
		await import("./../legalRepresentation/tokenUtils.ts"),
	...
	"/convex/listings/lifecycle.ts": async () =>
		await import("./../listings/lifecycle.ts"),
	...
	"/convex/listings/portalQueries.ts": async () =>
		await import("./../listings/portalQueries.ts"),
	"/convex/listings/portalVisibility.ts": async () =>
		await import("./../listings/portalVisibility.ts"),
	...
	"/convex/micPortfolio/contracts.ts": async () =>
		await import("./../micPortfolio/contracts.ts"),
