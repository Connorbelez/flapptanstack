...
This project is indexed by GitNexus as **fairlendapp** (25369 symbols, 36102 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
